...
public class GetTimeClockController {
    ...
    @GetMapping("/")
    public List<TimeClockOutputDto> getAll(@RequestParam (required = false) Integer employeeId){

        List<TimeClock> timeClockList = useCase.getAllByEmployeeId(employeeId);
