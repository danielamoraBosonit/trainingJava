...
INSERT INTO employee (name, surnames, birth_date, department, category) VALUES
    ('Carlos', 'Jimenez Garcia', '1984-09-18', 'Desarrollo', 'Senior'),
    ('Ana', 'Ruiz Lopez', '1991-01-02', 'QA', 'Midior'),
    ('Pedro', 'Fernandez Gomez', '1979-04-07', 'Desarrollo', 'Senior'),
    ('Laura', 'Gonzalo Martin', '1999-05-15', 'UX/UI', 'Senior'),
    ('Juan', 'Torres Navarro', '2002-10-27', 'Desarrollo', 'Junior');
